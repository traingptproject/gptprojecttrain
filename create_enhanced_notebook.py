...
notebook = {
    ...
    "cells": [
        ...
        {
            "cell_type": "markdown",
            "source": ["## 3. Clone Repository and Setup Files"],
        ...
        {
            "cell_type": "markdown",
            "source": ["## 4. Configure Training (Optional)"],
            "metadata": {"id": "config"}
        },
        {
            "cell_type": "code",
        ...
        {
            "cell_type": "markdown",
            "source": ["## 7. View Training Results"],
            "metadata": {"id": "results"}
        },
        {
            "cell_type": "code",
...
# Save notebook
with open('/home/ubuntu/gptprojecttrain/AutoTrain_GPU_Colab_Enhanced.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("✅ Enhanced Colab notebook created successfully!")
